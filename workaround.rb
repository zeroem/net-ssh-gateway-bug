...
begin
  puts 'Attempting to contact non-existant service...'
...
another_gateway = new_gateway

begin
  puts 'Attempting to contact real service...'
  another_gateway.open 'www.example.com', 80 do |local_port|
    puts "Local Port: #{local_port}"
    puts Net::HTTP.get('localhost', '/index.html', local_port)
  end
rescue Exception => e
...
shutdown_gateway another_gateway
